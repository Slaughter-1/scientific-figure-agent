...
def main(argv: list[str] | None = None) -> int:
    ...
    plot_parser.add_argument("--significance")
    plot_parser.add_argument("--x-label")
    plot_parser.add_argument("--y-label")
    ...
    if args.command == "plot":
        try:
            ...
            spec = build_plot_spec(table, kind=args.kind, x_column=args.x, y_column=args.y, y_error_column=args.y_error, significance_column=args.significance, x_label=args.x_label, y_label=args.y_label, matrix_columns=matrix_columns, title=args.title)
            output_dir = Path(args.output_dir)
